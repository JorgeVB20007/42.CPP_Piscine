...
/*   Updated: 2022/11/30 19:51:20 by jvacaris         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ost << "Form name: " << toprint.getName() << " | Required grades: " << toprint.getSignGrade() << " (sign) - " << toprint.getExecGrade() << " (execute) | Signed: " << toprint.getSignatureStatus() << ".";
	return (ost);
}
